        ...
        <aside class="more-right-side slide-in-from-left">
            ...
            <div v-for="(booking, index) in Bookings" :key="`booking_${index}`" class="more-card ticket-card">
                ...
                <div class="ticket-card__info-line">
                    ...
                    <div class="ticket-card__info-line__value">{{ `${booking.RecallBookingResponse.FerryComponents.FerryComponent.Sailings.Sailing[0].SailingInfo["@DepartPortName"]} - ${booking.RecallBookingResponse.FerryComponents.FerryComponent.Sailings.Sailing[0].SailingInfo["@DepartDateTime"].replaceAll('-', '/').replaceAll('T', ' ')}` }}</div>
                </div>
                <div class="dots">
                    <div></div>
                    <div></div>
                ...
                <div class="ticket-card__info-line">
                    ...
                    <div class="ticket-card__info-line__value">{{ `${booking.RecallBookingResponse.FerryComponents.FerryComponent.Sailings.Sailing[booking.RecallBookingResponse.FerryComponents.FerryComponent.Sailings.Sailing.length-1].SailingInfo["@DepartPortName"]} - ${booking.RecallBookingResponse.FerryComponents.FerryComponent.Sailings.Sailing[booking.RecallBookingResponse.FerryComponents.FerryComponent.Sailings.Sailing.length-1].SailingInfo["@DepartDateTime"].replaceAll('-', '/').replaceAll('T', ' ')}` }}</div>
                </div>

                <button v-if="type==='current'" @click="selectedBooking = booking">
    <svg style="margin-right: .4rem;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
