            ...
            <div class="grid-four fade-in-left" v-if="showTripList">
                <div v-for="(trip, index) in listedTrips" :key="`trip_item_${index}`" style="display: flex;
                    ...
                    <div class="travel-card">
                        ...
                        <div class="travel-rate-final">
                            ...
                            <button v-if="!showSummary" class="select-rate" @click="getSailtings(trip)">Select</button>
                        </div>
                    </div>
                </div>
                ...
                <div v-if="showSummary" style="text-align: -webkit-center;">
                    <div class="card-container">
                            ...
                            <table class="price-table">
                                ...
                                <tbody>
                                    <tr v-for="service in getServiceNames()" :key="service.serviceName">
                                        ...
                                        <td class="text-center font-bold">{{ service["Quantity"] }}</td>
                                        <td class="text-right font-bold">{{ service["unitCost"] }} &nbsp;€</td>
                                    </tr>
                                    <!-- More rows go here -->
                                </tbody>
                                <tfoot>
                                    <tr>
                                        <td class="font-bold">Vuosimaksu yhteensä</td>
                                        <td></td>
                                        <td class="text-right font-bold font-size-x-large">
                        ...
                        <div class="spacer"></div>
                        <p class="caption">*The price may change when the insurance period changes.</p>
                    </div>
                </div>
            </div>
