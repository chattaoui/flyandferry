            ...
            <div class="wrap-login100" style="height: 58vh">
              ...
              <Transition class="fade-in-left">
                <form v-if="parseInt(this.setStepper) == 1" class="login100-form validate-form">
                  ...
                  <div class="wrap-input100 validate-input">
                    <select class="select-class" v-model="newUser.title">
                  ...
                  <div class="wrap-input100 validate-input">
                    <input class="input100" type="text" name="Name" v-model="newUser.name" placeholder="Name" required />
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                  ...
                  <div class="wrap-input100 validate-input">
                    <input class="input100" type="text" name="Name" v-model="newUser['first name']" placeholder="First name"
                      required />
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                      <i class="fa fa-user" aria-hidden="true"></i>
                  ...
                  <div class="wrap-input100 validate-input">
                    <input class="input100" type="text" name="email" v-model="newUser.email" placeholder="Email"
                      required />
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                      <i class="fa fa-envelope" aria-hidden="true"></i>
              ...
              <Transition v-if="parseInt(this.setStepper) == 2">
                <div style="display: flex; align-items: center">
                  <div class="fade-in-left" style="width: 80%; padding: 6rem">
                    <svg class="last-step-pic" xmlns="http://www.w3.org/2000/svg"
                      xmlns:xlink="http://www.w3.org/1999/xlink" data-name="Layer 1" width="917.90945" height="521"
                      viewBox="0 0 917.90945 521">
                      <path
                      ...
                      <circle cx="819" cy="102" r="16" fill="white" />
                      <rect x="654.88184" y="101" width="169.11816" height="2" fill="white" />
                      <rect x="454.09448" y="101" width="156.28345" height="2" fill="white" />
                      <rect x="251.98438" y="101" width="157.6062" height="2" fill="white" />
                      <rect x="16" y="101" width="191.66931" height="2" fill="white" />
                      ...
                      <path d="M1057.95472,710.5h-381a1,1,0,0,1,0-2h381a1,1,0,0,1,0,2Z"
                        transform="translate(-141.04528 -189.5)" fill="#cacaca" />
                      <path
                        d="M371.04528,427.5a1,1,0,0,1-1-1v-112a1,1,0,0,1,2,0v112A1.00005,1.00005,0,0,1,371.04528,427.5Z"
                        transform="translate(-141.04528 -189.5)" fill="#3f3d56" />
                      <path
                        d="M300.50891,444.88a6.34567,6.34567,0,0,0,0,12.69134h141.0995a6.34568,6.34568,0,0,0,0-12.69134Z"
                        transform="translate(-141.04528 -189.5)" fill="white" />
                      <path
                        d="M338.34293,474.954a6.34568,6.34568,0,1,0-.02677,12.69134h65.45826a6.34567,6.34567,0,1,0,0-12.69134Z"
                        transform="translate(-141.04528 -189.5)" fill="white" />
                      <path
                        d="M505.50891,444.88a6.34567,6.34567,0,0,0,0,12.69134h141.0995a6.34568,6.34568,0,0,0,0-12.69134Z"
                        transform="translate(-141.04528 -189.5)" fill="white" />
                      <path
                        d="M543.34293,474.954a6.34568,6.34568,0,1,0-.02677,12.69134h65.45826a6.34567,6.34567,0,1,0,0-12.69134Z"
                        transform="translate(-141.04528 -189.5)" fill="white" />
                      <path
                        d="M576.04528,427.5a1,1,0,0,1-1-1v-112a1,1,0,0,1,2,0v112A1.00005,1.00005,0,0,1,576.04528,427.5Z"
                        transform="translate(-141.04528 -189.5)" fill="#3f3d56" />
                    </svg>
                  </div>
                  <form class="fade-in-right login100-form validate-form">

                    <div class="wrap-input100 validate-input">
                      <select class="select-class" @change="selectedCountry" v-model="newUser.country" style="padding:0 41% 0 1em!important">
                        <option :value="{}" selected disabled hidden>Country</option>
                        <option v-for="country in Countries" :value="{Name: country.name.common, Code: country.cca3}" :key="country.name.common">{{ country.name.common }}</option>
                      </select>
                    </div>
                    ...
                    <div class="wrap-input100 validate-input" style="margin-bottom: 4rem;">
                      <input class="input100" type="text" name="Name" placeholder="Postal code"
                        v-model="newUser['postal code']" required />
                      <span class="focus-input100"></span>
                      <span class="symbol-input100">
...
.select-class {
  ...
  padding: 0 10.3em 0 1em;
  background: url(../assets/arrow-down.svg) no-repeat right 0.8em center / 1.4em,
    #e6e6e6;
  color: #666666;
  border-radius: 25px;
  cursor: pointer;
...
.login-container:before {
  ...
  height: 0px;
  padding: 0px;
  background: url("/public/html_template/img/1165589_8685.jpg");
