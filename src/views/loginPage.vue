      ...
      <div class="first-signup-step">
        ...
        <div class="wrap-login100" style="height: 58vh">
          ...
          <Transition class="fade-in-left">
            <form
              v-if="parseInt(this.setStepper) == 1"
            ...
            <div style="display: flex; align-items: center">
              <div class="fade-in-left" style="width: 80%; padding: 6rem">
                ...
                >
                  ...
                  <g>
                    <path
                      id="uuid-1b03a630-7e31-41b5-b302-96493ff31189-222"
                  ...
                  <path
                    id="uuid-b40723c2-846b-43d4-8d7a-d7be28bdc184-223"
              ...
              <div class="fade-in-left" style="width: 80%; padding: 6rem">
                ...
                >
                  <path
                    ...
                    transform="translate(-141.04528 -189.5)"
                    fill="#f0f0f0"
                  />
                  <path
                  ...
                  />
                  <path
                    d="M376.04528,319a22.5,22.5,0,1,1,22.5-22.5A22.52538,22.52538,0,0,1,376.04528,319Z"
                    transform="translate(-141.04528 -189.5)"
                    fill="#6e4ab5"
                  />
                  <path
                  ...
                  />
                  <path
                    d="M578.04528,319a22.5,22.5,0,1,1,22.5-22.5A22.52538,22.52538,0,0,1,578.04528,319Z"
                    transform="translate(-141.04528 -189.5)"
                    fill="#6e4ab5"
                  />
                  <path
                  ...
                  />
                  <path
                    d="M779.04528,319a22.5,22.5,0,1,1,22.5-22.5A22.52538,22.52538,0,0,1,779.04528,319Z"
                    transform="translate(-141.04528 -189.5)"
                    fill="#f0f0f0"
                  />
                  <path
                  ...
                  />
                  <path
                    d="M759.6122,408.01575a22.5,22.5,0,1,1,22.5-22.5A22.52539,22.52539,0,0,1,759.6122,408.01575Z"
                    transform="translate(-141.04528 -189.5)"
                    fill="#6e4ab5"
                  />
                  <path
                  ...
                  <circle
                    ...
                    cy="225.61756"
                    r="29.72869"
                    transform="translate(-142.77094 254.98063) rotate(-28.66318)"
                    fill="#9e616a"
                  />
                  <path
                  ...
                  />
                  <path
                    d="M1057.95472,710.5h-381a1,1,0,0,1,0-2h381a1,1,0,0,1,0,2Z"
                    transform="translate(-141.04528 -189.5)"
                    fill="#cacaca"
                  />
                  <path
        ...
        <div class="container-login100-form-btn">
          <button
            v-if="parseInt(this.setStepper) < 3"
  ...
  methods: {
    ...
    async finishSignUp() {
      try {
        await this.$axios
          .post(
            "http://localhost:3010/api/Authentication_API/register",
            this.newUser
          )
          .then((res) => {
            console.log(res);
