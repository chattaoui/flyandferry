              ...
              <div class="fade-in-left" style="width: 80%; padding: 6rem">
                <svg class="last-step-pic" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                  ...
                  <path d="M376.04528,319a22.5,22.5,0,1,1,22.5-22.5A22.52538,22.52538,0,0,1,376.04528,319Z"
                    transform="translate(-141.04528 -189.5)" fill="#6e4ab5" />
                  <path
...
export default {
  ...
  methods: {
    ...
    async loginUser() {
      try {
        await this.$axios.post("http://localhost:3010/api/Authentication_API/login", {
    ...
    async finishSignUp() {
      ...
      try {
        await this.$axios
          .post(
            "http://localhost:3010/api/Authentication_API/validate-pin",
